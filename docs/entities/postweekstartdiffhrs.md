# postWeekStartDiffHrs

> Auto-generated from a Data Dictionary workbook. Output is public-safe by default.

## What it is

The difference between the partitionDate (Scheduled Week Start Date) and firstPostDtm this number will be negative if it's early and positive if its late

...
Start timezone where the worked shift was entered. Normally, this is the default or home timezone for the employee, but the worked shift can include a different timezone as necessary.

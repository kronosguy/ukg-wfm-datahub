...
The name of the associated punch interpretation rule that determines when punches link to schedules and when data collection devices accept and reject punches.

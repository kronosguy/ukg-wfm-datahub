...
A Boolean indicator of whether or not the projected totals are calculated and stored. Schedule totals are calculated and stored regardless of this setting.

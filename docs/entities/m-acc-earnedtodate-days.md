# M_Acc_EarnedToDate_Days

> Auto-generated from a Data Dictionary workbook. Output is public-safe by default.

## What it is

The number of days earned as of the partitionDate. If using an  accrual policy which involves for example accruing vacation for every day or hour worked, then earned will be the days of vacation accrued as of the partitionDate

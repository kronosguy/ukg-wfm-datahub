...
Enable edits after sign-off: -1 indicates 'enable edits after the lock is removed manually or by payroll interface'. 0, ö, 999 indicate the amount of hours to enable edits after the end of the pay period.

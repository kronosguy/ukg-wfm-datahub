# skipBreaksInLaborSwt

> Auto-generated from a Data Dictionary workbook. Output is public-safe by default.

## What it is

A Boolean indicator of whether or not the Forecast Manager ignores breaks when it calculates labor hours for a given day when there are gaps of a specified duration in the labor requirements on either side of the day divide.

...
- Hours/Wages by Paycode/Business Structure/Person/Date, from the Schedules

## Metadata

| Field | Value |
| --- | --- |
| Dataset / View / Table | vScheduleTotal |
| Unique Identifier | personId,partitionDate, signedOffSwt, amountType (nullable), wages (nullable), hoursAmount (nullable), daysAmount (nullable), combined pay codeswt (nullable), payCode (nullable), payCodeId (nullable), wageMultiplier (nullable), payPeriodWeek (nullable), payPeriodNumber (nullable), , laborTransferSwt, wageAddition (nullable), orgTransferSwt, orgId (nullable), isFromCorrectionSwt, costCenterId (nullable), uniqueId, laborEntryName1 (nullable), laborEntryName2 (nullable), laborEntryName3 (nullable), laborEntryName4 (nullable), laborEntryName5 (nullable), laborEntryName6 (nullable), laborEntryDesc1 (nullable), laborEntryDesc2 (nullable), laborEntryDesc3 (nullable), laborEntryDesc4 (nullable), laborEntryDesc5 (nullable), laborEntryDesc6 (nullable),updateDtm, costCenter (nullable) |
...
| payCode | STRING | Name of the pay code transactions are charged to |  |  |

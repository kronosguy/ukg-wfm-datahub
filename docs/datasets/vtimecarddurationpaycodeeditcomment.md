# vTimecardDurationPaycodeEditComment
...
| Field | Value |
| --- | --- |
| Dataset / View / Table | vTimecardDurationPaycodeEditComment |
| Unique Identifier | hourWorkedId,commentId, commentCategoryId, commentNoteId, timestamp (nullable) |

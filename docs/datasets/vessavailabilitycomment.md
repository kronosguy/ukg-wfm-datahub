# vEssAvailabilityComment

**Group:** Detail Dataset → Employee Self Service Detail Views

- Availability Request Comments

## Metadata

| Field | Value |
| --- | --- |
| Dataset / View / Table | vEssAvailabilityComment |
| Unique Identifier | essAvailabilityId,partitionDate,personId,commentNoteId,commentId |
